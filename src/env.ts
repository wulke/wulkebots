...
type InputEnv = Partial<Record<'JWT_SECRET' | 'DATABASE_URL' | 'UPLOADS_DIR' | 'PORT', string>>;
...
function requireValue(name: keyof RuntimeEnv, value: string | undefined): string {
...
export function validateEnv(env: InputEnv): RuntimeEnv {
